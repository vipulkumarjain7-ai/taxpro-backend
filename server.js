...
// ── Database ───────────────────────────────────────────────────────────────
const sqlite3 = new database.Database(process.env.DB_PATH || "./taxpro.db");
sqlite3.run("PRAGMA journal_mode = WAL");
sqlite3.run("PRAGMA foreign_keys = ON");

sqlite3.serialize(() => {
sqlite3.run(`CREATE TABLE IF NOT EXISTS users (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS clients (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS notices (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS returns (
    id TEXT PRIMARY KEY, user_id TEXT NOT NULL, client_id TEXT NOT NULL,
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS reconciliation (
    id TEXT PRIMARY KEY, user_id TEXT NOT NULL, client_id TEXT NOT NULL,
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS challans (
    id TEXT PRIMARY KEY, user_id TEXT NOT NULL, client_id TEXT NOT NULL,
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS products (
    id TEXT PRIMARY KEY, user_id TEXT NOT NULL, name TEXT NOT NULL,
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS invoices (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS invoice_items (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS stock_movements (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS payments (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS bank_transactions (
  ...
  sqlite3.run(`CREATE TABLE IF NOT EXISTS bank_imports (
    id TEXT PRIMARY KEY, user_id TEXT NOT NULL, bank_name TEXT,
